...
class CDEvaluator:
    ...
    def save_image_label(self):
        ...
        save_images(pre_A, self.file_list, self.file_label_list, epo=self.batch_id, batch_size=self.args.batch_size, directory=directory_A,
                    num_class=6, road_path=road_path_A, road_path_label=road_path_A_label)

        save_images(pre_B, self.file_list, self.file_label_list, epo=self.batch_id, batch_size=self.args.batch_size, directory=directory_B,
                    num_class=6, road_path=road_path_B, road_path_label=road_path_B_label)

        save_images1(pre_CH, self.file_list, self.file_label_list, epo=self.batch_id, batch_size=self.args.batch_size, directory=directory_CD,
