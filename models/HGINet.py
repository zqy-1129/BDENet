...
class HGINet(nn.Module):
    def __init__(self, channel=64, num_classes=6, pretrained_path=r'D:\SCD\pretrained\pvt_v2_b2.pth', drop_rate = 0.4):
        ...
        self.out_feature1 = nn.Conv2d(32, 2, 1)
    ...
    def forward(self, t1, t2):
        ...
        ##output
        prediction1_1 = F.interpolate(change, scale_factor=4, mode='bilinear')  # CD
        prediction1_2 = F.interpolate(output1, scale_factor=4, mode='bilinear')  # SegA
        prediction1_3 = F.interpolate(output2, scale_factor=4, mode='bilinear')  # SegB

        return prediction1_2, prediction1_3, prediction1_1
