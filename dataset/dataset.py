...
class ImageDataset(data.Dataset):
    def __init__(self, root_dir="D:\\study\\data\\podata", split='train', img_size=256, is_train=True,
                 to_tensor=True,
                 muti_scale=False):
    ...
    def __getitem__(self, index):
        ...
        if self.muti_scale:
            ...
            return {'A_1': img_A_1, 'A_2': img_A_2, 'B_1': img_B_1, 'B_2': img_B_2, 'name': name_1, 'name_2': name_2}
...
class Dataset(ImageDataset):
    ...
    def __getitem__(self, index):
        ...
        if self.muti_scale:
            ...
            [img_A_1, img_B_1], [img_A_2, img_B_2], [label], [label_A], [label_B] = \
                self.augmentation.transform_muti_scale([img_A_1, img_B_1],
                                                       [img_A_2, img_B_2], [label], [label_A], [label_B],
                                                       to_tensor=self.to_tensor)
            return img_A_1, img_A_2, label_A, img_B_1, img_B_2, label_B, label
            ...
            [img_A, img_B], [label], [label_A], [label_B] = self.augmentation.transform(
                [img_A, img_B], [label], [label_A], [label_B], to_tensor=self.to_tensor)
